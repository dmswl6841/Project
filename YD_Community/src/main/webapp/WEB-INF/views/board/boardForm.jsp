			...
			<div class="board_write_wrap">
				<div class="board_write">
					...
					<div class="info">
						<dl>
							<dt>작성자</dt>
							<dd><input type="text" id="boardWriter" name="boardWriter"
									value="${member.memberNick}" readonly>
							</dd>
						</dl>
						...
						<dl>
							<dd><input type="hidden" id="MemberNo" name="MemberNo"
									value="${member.memberNo }"></dd>
						</dl>
					</div>

					<div class="cont">
						<textarea id="boardSubject" name="boardSubject"
				...
				<div>
					<input type="submit" class="btn btn-success btn-lg" value="저장">&nbsp;&nbsp;&nbsp;
					<input type="reset" class="btn btn-success btn-lg" value="취소">
				</div>
			</div>
		</form>
	</div>
